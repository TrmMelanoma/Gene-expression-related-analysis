...
myoutf <- "/dartfs-hpc/rc/lab/T/TurkLab/Jichang/scRNAseq/combine/RNA/vitiligo/STB1356/CD8_STB1356/TCRseqed/clean_CD8_exp_fromraw/sctransform/PCx/res.0.4/matched_TCR/non_tumor_targeting_Trm_list.xls"
write.table(tmp.markers,myoutf,sep="\t",quote=F)

tmp.markers<-FindMarkers(CD8_STB1356,
                         ident.1=c('7'),logfc.threshold = 0.01)
myoutf <- "/dartfs-hpc/rc/lab/T/TurkLab/Jichang/scRNAseq/combine/RNA/vitiligo/STB1356/CD8_STB1356/TCRseqed/clean_CD8_exp_fromraw/sctransform/PCx/res.0.4/matched_TCR/Tex_list.xls"
write.table(tmp.markers,myoutf,sep="\t",quote=F)

tmp.markers<-FindMarkers(CD8_STB1356,
                         ident.1=c('1'),logfc.threshold = 0.01)
myoutf <- "/dartfs-hpc/rc/lab/T/TurkLab/Jichang/scRNAseq/combine/RNA/vitiligo/STB1356/CD8_STB1356/TCRseqed/clean_CD8_exp_fromraw/sctransform/PCx/res.0.4/matched_TCR/tumor_targeting_Trm_list.xls"
write.table(tmp.markers,myoutf,sep="\t",quote=F)

#########K-M plot and Forest plot using the TCGA data###############
#K-M plot
rm(list=ls())
myinf1 = "/lorax/chenglab/cc59/PubDat/Dataset/Firehose/RNAseqv2_Hiseq/processed/SKCM_RNAseqv2_ALL_Symbol.rda" #gene expression
myinf2 = "/lorax/chenglab/cc59/PubDat/Dataset/Firehose/Clinical/processed2/SKCM_Clincial_info.txt" #clinical information
myinf4 <- "/dartfs-hpc/rc/lab/T/TurkLab/Jichang/scRNAseq/combine/RNA/vitiligo/STB1356/CD8_STB1356/TCRseqed/clean_CD8_exp_fromraw/sctransform/PCx/res.0.4/survival/signatures/" #gene signature
...
for(i in 1 : ncol(res))
{
  ...
  myoutf = paste0("/dartfs-hpc/rc/lab/T/TurkLab/Jichang/scRNAseq/combine/RNA/vitiligo/STB1356/CD8_STB1356/TCRseqed/clean_CD8_exp_fromraw/sctransform/PCx/res.0.4/survival/TCGA/Mets/cebersort/0.25/TCGA_",colnames(res)[i],".pdf")
...
row.names(data) = sam
myinf2 <- "/lorax/chenglab/cc59/PubDat/Dataset/Firehose/Clinical/processed2/SKCM_Clincial_info.txt" 
...
library(ggplot2)
myoutf <-"/dartfs-hpc/rc/lab/T/TurkLab/Jichang/scRNAseq/combine/RNA/vitiligo/STB1356/CD8_STB1356/TCRseqed/clean_CD8_exp_fromraw/sctransform/PCx/res.0.4/survival/TCGA/Mets/nocebersort/0.25/forest_TrmTOX_Tcell.pdf"
